...
newdata$city<-agree$Incident.City.x
newdata$state<-agree$Incident.State.x
...
newdata1$city<-disagree1_city$Incident.City.x
newdata1$state<-disagree1_city$Incident.State.x
...
inc1<-cbind.data.frame(Incident.number=4745.2,
...
inc1<-cbind.data.frame(Incident.number=4219.1,
...
inc1<-cbind.data.frame(Incident.number=4219.2,
                       Title="VIDEO: East Bay Jewish community concerned over recent hate crimes, says they're connected to alt-right rally.1",
                       URL="http://kron4.com/2017/08/23/video-east-bay-jewish-community-concerned-over-recent-hate-crimes-says-upcoming-alt-right-rally-is-to-blame/",
                       day=20,
                       month=8,
