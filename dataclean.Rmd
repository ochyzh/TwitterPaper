...
fulldata$state[fulldata$city=="D.C"]<-"NA"
...
fulldata$numperp[fulldata$inc.id==2190]<-"a different train incident from Antoine Thomas"
...
fulldata$URL[fulldata$inc.id==4020]<-"https://www.readingeagle.com/ap/article/fear-resolve-and-more-security-at-charlottesvilles-temple"
...
fulldata$notes[fulldata$inc.id ==4406]<-"Cleveland"
...
fulldata$notes[fulldata$inc.id %in% c("5222","5235")]<-"David Harris, Jesse Harris and Austin Taggart"
...
fulldata$day[fulldata$inc.id ==5270]<-9

fulldata$day[fulldata$inc.id ==5355]<-"duplicate of 5270"
...
fulldata$day[fulldata$inc.id ==4957]<-9
