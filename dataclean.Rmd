...
mydata$Notes.x[mydata$Incident.number %in% c("4210","4335","4405")]<-"Nigel Garrett and Cameron Ajiduah"
...
newdata$Incident.number=agree$Incident.number
newdata$day<-agree$Day.of.Incident.x
newdata$month<-agree$Month.of.Incident.x
newdata$year<-agree$Year.of.Incident.x
...
newdata1$Incident.number=disagree1_city$Incident.number
newdata1$day<-disagree1_city$Day.of.Incident.x
newdata1$month<-disagree1_city$Month.of.Incident.x
newdata1$year<-disagree1_city$Year.of.Incident.x
...
newdata2$Incident.number=disagree1_mo$Incident.number
newdata2$day<-disagree1_mo$Day.of.Incident.x
newdata2$month<-disagree1_mo$Month.of.Incident.x
newdata2$year<-disagree1_mo$Year.of.Incident.x
...
newdata3$day<-disagree1_any1$Day.of.Incident.y
newdata3$month<-disagree1_any1$Month.of.Incident.y
...
newdata3$city<-disagree1_any1$Incident.City.y
newdata3$state<-disagree1_any1$Incident.State.y
...
newdata3$notes<-paste(disagree1_any1$Notes.x,disagree1_any$Notes.y)
...
newdata4$type<-disagree1_add$Incident.Type
...
inc1<-cbind.data.frame(inc.id=4219.1,
...
inc1<-cbind.data.frame(inc.id=4219.2,
                       Title="VIDEO: East Bay Jewish community concerned over recent hate crimes, says they're connected to alt-right rally.1",
                       URL="http://kron4.com/2017/08/23/video-east-bay-jewish-community-concerned-over-recent-hate-crimes-says-upcoming-alt-right-rally-is-to-blame/",
                       day=20,
                       month=8,
...
write.csv(agree, "CleanData/test1.csv", row.names = FALSE)
