...
newdata<-cbind.data.frame(newdata,inc1,inc2,inc3,inc4,inc5,inc6,inc7,inc8,inc9,inc10,inc11,inc12,inc13,inc14,inc15)

fulldata<-rbind.data.frame(newdata_all,newdata_all1, newdata_all2,newdata)

write.csv(fulldata, "CleanData/test1.csv", row.names = FALSE)
